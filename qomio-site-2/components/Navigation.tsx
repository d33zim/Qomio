  ...
  return (
    <nav className="fixed top-0 left-0 w-full px-4 md:px-6 py-5 flex justify-between items-center z-50 mix-blend-difference text-white pointer-events-none">
      ...
      <div className="flex items-center gap-4 md:gap-10 pointer-events-auto">
        ...
        <Link
          href="#kontakt"
          className="bg-white text-black px-5 py-2 rounded-full font-mono text-xs font-bold uppercase tracking-widest hover:[background-color:rgb(239,63,33)] hover:text-white transition-colors duration-200 magnetic-btn shadow-lg"
        >
          Kontakt
        </Link>
      </div>
